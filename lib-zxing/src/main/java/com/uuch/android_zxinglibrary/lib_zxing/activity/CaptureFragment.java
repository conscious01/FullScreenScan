...
import com.uuch.android_zxinglibrary.lib_zxing.camera.CameraManager;
import com.uuch.android_zxinglibrary.lib_zxing.decoding.CaptureActivityHandler;
import com.uuch.android_zxinglibrary.lib_zxing.decoding.InactivityTimer;
import com.uuch.android_zxinglibrary.lib_zxing.view.ViewfinderView;
...
public class CaptureFragment extends Fragment implements SurfaceHolder.Callback {
    ...
    private com.uuch.android_zxinglibrary.lib_zxing.activity.CodeUtils.AnalyzeCallback analyzeCallback;
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        View view = null;
        if (bundle != null) {
            int layoutId = bundle.getInt(com.uuch.android_zxinglibrary.lib_zxing.activity.CodeUtils.LAYOUT_ID);
            if (layoutId != -1) {
    ...
    public com.uuch.android_zxinglibrary.lib_zxing.activity.CodeUtils.AnalyzeCallback getAnalyzeCallback() {
        return analyzeCallback;
    }

    public void setAnalyzeCallback(com.uuch.android_zxinglibrary.lib_zxing.activity.CodeUtils.AnalyzeCallback analyzeCallback) {
